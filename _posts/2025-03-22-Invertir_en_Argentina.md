...
## ¿Se puede invertir en Argentina desde España?
...
- Demografía: Una población joven (25-30% menor de 25 años), educada y urbana.
- Recursos: Litio, agricultura, gas (Vaca Muerta)... 
- Turismo: Desde la Patagonia hasta Iguazú, el potencial es enorme, especialmente con un tipo de cambio favorable.

### ¿Qué opciones hay desde España?
He estado investigando los instrumentos accesibles para inversores españoles y esto es lo que encontré:

#### Fondos de inversión: un desierto
...
#### ETFs: Global X MSCI Argentina ($ARGT)
...
- **ETF $ARGT**: Si tu broker te lo permite, es la vía más diversificada. Si no, explora las opciones con Interactive Brokers.
- **Acciones**: Compra $MELI, YPF o similares en tu broker
